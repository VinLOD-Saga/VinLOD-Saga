...
painting_df = pd.read_csv("csv_to_rdf/csv_files/Manga.csv")
graph = rdf.Graph()
...
subj = rdf.URIRef("https://w3id.org/vinLOD-saga/item/Vinland_Manga")
...
graph.serialize(destination="turtle_files/manga.ttl", format="turtle")
